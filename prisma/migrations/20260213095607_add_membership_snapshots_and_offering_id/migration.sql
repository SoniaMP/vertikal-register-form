...
INSERT INTO "new_Membership" ("categoryId", "confirmationSent", "consentedAt", "createdAt", "federationSubtypeId", "federationTypeId", "id", "isFederated", "memberId", "paymentStatus", "seasonId", "status", "stripePaymentId", "stripeSessionId", "totalAmount", "updatedAt", "year") SELECT "categoryId", "confirmationSent", "consentedAt", "createdAt", "federationSubtypeId", "federationTypeId", "id", "isFederated", "memberId", "paymentStatus", "seasonId", "status", "stripePaymentId", "stripeSessionId", "totalAmount", "updatedAt", "year" FROM "Membership";
