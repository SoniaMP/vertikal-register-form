...
INSERT INTO "new_Membership" ("categoryId", "confirmationSent", "consentedAt", "createdAt", "id", "isFederated", "licenseLabelSnapshot", "licensePriceSnapshot", "memberId", "offeringId", "paymentStatus", "seasonId", "status", "stripePaymentId", "stripeSessionId", "subtypeId", "totalAmount", "typeId", "updatedAt", "year") SELECT "categoryId", "confirmationSent", "consentedAt", "createdAt", "id", "isFederated", coalesce("licenseLabelSnapshot", '') AS "licenseLabelSnapshot", coalesce("licensePriceSnapshot", 0) AS "licensePriceSnapshot", "memberId", "offeringId", "paymentStatus", "seasonId", "status", "stripePaymentId", "stripeSessionId", "subtypeId", "totalAmount", "typeId", "updatedAt", "year" FROM "Membership";
