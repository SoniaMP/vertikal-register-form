...
INSERT INTO "new_Registration" ("active", "address", "categoryId", "city", "confirmationSent", "createdAt", "dateOfBirth", "dni", "email", "federationSubtypeId", "federationTypeId", "firstName", "id", "lastName", "paymentStatus", "phone", "postalCode", "province", "stripePaymentId", "stripeSessionId", "totalAmount", "updatedAt") SELECT "active", "address", "categoryId", "city", "confirmationSent", "createdAt", "dateOfBirth", "dni", "email", "federationSubtypeId", "federationTypeId", "firstName", "id", "lastName", "paymentStatus", "phone", "postalCode", "province", "stripePaymentId", "stripeSessionId", "totalAmount", "updatedAt" FROM "Registration";
