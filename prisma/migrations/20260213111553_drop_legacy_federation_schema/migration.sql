/*
  ...
  - You are about to drop the `FederationSubtype` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `FederationType` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `federationSubtypeId` on the `Membership` table. All the data in the column will be lost.
  - You are about to drop the column `federationTypeId` on the `Membership` table. All the data in the column will be lost.
