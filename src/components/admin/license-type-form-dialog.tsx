...
export function LicenseTypeFormDialog({
  open,
  onOpenChange,
  licenseType,
}: Props) {
  ...
  const action = isEditing
    ? updateLicenseType.bind(null, licenseType.id)
    : createLicenseType;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {isEditing
              ? "Editar tipo de federativa"
              : "Nuevo tipo de federativa"}
          </DialogTitle>
        </DialogHeader>
